...
kubectl apply -f https://raw.githubusercontent.com/outscale/cloud-provider-osc/v0.1.1/deploy/osc-ccm-manifest.yml
```
...
```
kubectl delete -f https://raw.githubusercontent.com/outscale/cloud-provider-osc/v0.1.1/deploy/osc-ccm-manifest.yml
